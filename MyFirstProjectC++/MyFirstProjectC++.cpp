//#include <iostream>
//using namespace std;
//void CalculatingMoney() {
//
//	unsigned long long FiftyDinars, ShillingWeHave;
...
//	cin >> ShillingWeHave;
//	FiftyDinars = ShillingWeHave / 1000;
//	ShillingWeHave %= 1000;
//	TwentyDinar = ShillingWeHave / 400;
//	ShillingWeHave %= 400;
//	TenDinar = ShillingWeHave / 200;
//	ShillingWeHave %= 200;
//	FiveDinar = ShillingWeHave / 100;
//	ShillingWeHave %= 100;
//	OneDinar = ShillingWeHave / 20;
//	ShillingWeHave %= 20;
//	HalfDinar = ShillingWeHave / 10;
//	ShillingWeHave %= 10;
//	QuarterDinar = ShillingWeHave / 5;
//	ShillingWeHave %= 5;
//	TenPiastres = ShillingWeHave / 2;
//	ShillingWeHave %= 2;
//	Shilling = ShillingWeHave;
//	cout << "\a***********************"<<endl;
//	cout << "The number of fifty dinars ----> " << FiftyDinars << endl;
//	cout << "The number of twenty dinars ---> " << TwentyDinar << endl;
//	cout << "The number of ten dinars ------> " << TenDinar << endl;
//	cout << "The number of five dinars -----> " << FiveDinar << endl;
//	cout << "The number of one dinars ------> " << OneDinar << endl;
//	cout << "The number of half dinars -----> " << HalfDinar << endl;
//	cout << "The number of quarter dinars --> " << QuarterDinar << endl;
//	cout << "The number of ten piastres ----> " << TenPiastres << endl;
//	cout << "The number of Shilling --------> " << Shilling << endl;
//}
//int main() {
//	CalculatingMoney();
//}
